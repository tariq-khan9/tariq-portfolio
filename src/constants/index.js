...
const experiences = [
  ...
  },
  {
    ...
    points:
      "Gistoscope is an online social forum (in-progress) where users can browse, create, critique, edit posts, and start discussions based on specific parts of others' writings.",
  },
  {
    title: "Simplest-Math",
    image: simple,
    ...
    points:
      "SimplestMath is an online platform designed for math practice and learning. It offers practice sheets covering key math topics such as arithmetic, fractions, algebra, and geometry. you can explore the application at https://simplestmath.com/.",
  },
  {
    title: "Read-Insights",
    image: insights,
    ...
    points:
      "A blog platform using React.js, Graphql, Strapi-5, and PostgreSQL. It allows authors to create, manage, and delete rich text posts, while visitors can browse by category, author, or view recent posts. ",
  },
  {
    ...
    points:
      "This web-based platform with a blog-like interface enables user registration and login via Clerk authentication. Users can explore posts related to specific subjects and search for content or authors. The app is hosted on Vercel and accessible at https://green-messengers.vercel.app.",
  },
  {
    ...
    points:
      "Daily Soldouts is a MERN-based web application for managing daily sold-out products with user registration, authentication, and visualizing monthly trends through clear graphs, simplifying data analysis for efficient decision-making.",
  },
  {
    title: "T-Stores",
    ...
    points:
      "T-Store is an online product showcase where users can  explore a diverse array of items. Its user-friendly interface, powered by ReactJS and Material UI, provided with robust functionality of its Laravel backend. Furthermore, the app includes an admin panel, facilitating effective application management.",
  },
  {
