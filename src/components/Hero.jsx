...
const Hero = () => {
  return (
    <div className="pt-2 mb-36 md:mb-8  w-full flex flex-col md:flex-row space-x-20">
      <motion.div variants={fadeIn("right", "type", 0.5, 2)}>
        <div className={` pt-10 pr-20   flex flex-row items-start gap-5`}>
          ...
          <div>
            ...
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              I build innovative, visually appealing{" "}
      ...
      <Tilt>
        <div className="pr-0 mr-0">
          <motion.div variants={fadeIn("left", "type", 1, 2)}>
