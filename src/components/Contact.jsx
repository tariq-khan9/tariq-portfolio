...
const Contact = () => {
  ...
  return (
    <div className={`mt-12 bg-black-70 rounded-[20px]`}>
      ...
      >
        <p className="sm:text-[18px] ml-8  text-[14px] text-secondary uppercase tracking-wider">
          Get in touch
        </p>
        <h3 className="text-white ml-8 font-black md:text-[45px] sm:text-[35px] xs:text-[25px] text-[20px]">
        ...
        <div className="flex lg:flex-row flex-col">
          ...
          <div className="md:ml-9 mt-10 p-6 pt-7 xs:w-[330px] w-[280px]  md:mb-1 rounded-xl md:w-[500px] md:mr-8 bg-tertiary">
            <div className="flex  flex-col ">
              ...
              />
              <Link
                to="https://www.linkedin.com/in/tariq-khan-1877a5229/"
                className="mt-2 break-words ml-2"
              >
                https://www.linkedin.com/in/tariq-khan-1877a5229
              </Link>
            </div>
            ...
            <div className="flex mt-7  flex-col ">
              <img
                ...
                alt="github"
              />
              <Link to="https://github.com/tariq-khan9" className="mt-1 ml-2">
                https://github.com/tariq-khan9
              </Link>
            </div>
